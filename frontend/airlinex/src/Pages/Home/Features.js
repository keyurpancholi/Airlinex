          ...
          <CardActionArea>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Protect yourself from hefty flight cancellation charges. Click
                here to know more about cancellation protection. Available for
        ...
        <Card sx={{ maxWidth: 345 }}>
          <CardActionArea>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Domestic and international Flight. We offer best deals on flight
                bookings, hotel bookings, bus tickets, irctc train tickets, fly
                and stay and holiday packages.
              </Typography>
            </CardContent>
          </CardActionArea>
        </Card>
        <Card sx={{ maxWidth: 345 }}>
          <CardActionArea>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Enjoy A Cool Trip To Dubai, Boston, Or Delhi With Airlinex. Book
                Now. Explore many different cities and countires, All On Your
                Own With Airlinex. Book Now.
              </Typography>
            </CardContent>
          </CardActionArea>
        </Card>
